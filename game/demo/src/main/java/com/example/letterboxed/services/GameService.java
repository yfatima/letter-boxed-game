...
/**
 * This GameService class methods are called by the GameController to do backend
 * data processing and logical work.
 */
@Service
public class GameService {
    ...
    /**
     * This method creates the new game with the given player assigned as player 1
     * in the game.
     * Each game has 4 or less vowels chosen randomly and has 12 or less consonants
     * chosen randomly as well.
     * 
     * @param player
    ...
    public Game createNewGame(Player player) {
        try {
            FileHandler logfile = new FileHandler("game/demo/src/main/java/com/example/letterboxed/data/newgamelog.log",
                    2000, 1, true);
            ...
            Character consonants[] = { 'B', 'C', 'D', 'F', 'G', 'H', 'J', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T',
                    'V', 'W', 'X', 'Y', 'Z' };
    ...
    /**
     * This method adds the given player as player 2 in the game and starts the game
     * by changing gamestatus.
     * 
     * @param player
     * @param gameId
    ...
    public Game joinGame(Player player, String gameId) {
        ...
        try {
            FileHandler logfile = new FileHandler(
                    "game/demo/src/main/java/com/example/letterboxed/data/joinggamelog.log",
                    2000, 1, true);
            Logger.getLogger("").addHandler(logfile);
            logger.setLevel(Level.ALL);
            ...
            try {
                ...
                if (game.getId().equals(gameId) && game.getP2Id().equals("none")
                        && !(game.getP1Id().equals("none") || game.getP1Id().equals(player.getUserName()))) {
    ...
    /**
     * This method search the game json data file to find the game with the given
     * game id
     * 
     * @param id
     * @return Game game
    ...
    /**
     * This methods changes the gamestatus by setting it to the username of the
