...
/**
 * This MoveService class methods are called by the MoveController to do backend
...
public class MoveService {
     ...
     * player who made the move +1 score.
     * 
     * @param gameId
    ...
    public Game skipMove(String gameId) {
        System.out.println(gameId + "in service skip move\n");
        Game game = null;
